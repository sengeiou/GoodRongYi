package com.lichi.goodrongyi.logger;
...
final class LoggerPrinter implements Printer {
    ...
    /**
     * tag is used for the Log, the carName is a little different
    ...
    /**
     * Formats the json book_line_content_list and print it
     *
     * @param json the json book_line_content_list
     */
    @Override
    public void json(String json) {
        if (Helper.isEmpty(json)) {
            d("Empty/Null json book_line_content_list");
            return;
        }
        try {
            json = json.trim();
     ...
     * Formats the json book_line_content_list and print it
     *
     * @param xml the xml book_line_content_list
     */
    @Override
    public void xml(String xml) {
        if (Helper.isEmpty(xml)) {
            d("Empty/Null xml book_line_content_list");
            return;
        }
        try {
