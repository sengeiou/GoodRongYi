...
public class SplendidEssayActivity extends BaseActivity<EssayView, EssayPresenter> implements EssayView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splendid_essay);
        initView();
    ...
    public void loadMore() {
        mPresenter.getArticleHotList(page);
    }
