 ...
 */
public class SignedClassFragment extends BaseFragment<PaidClassView, PaidClassPresenter> implements PaidClassView, OnLoadmoreListener, OnRefreshListener {
    ...
    public void initData() {
        mPresenter.getMyClass(page, 0, IOUtils.getUserId(getContext()));
    }
