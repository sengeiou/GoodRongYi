 ...
 * 手动添加账单
 */
public class ImportCreditCardActivity extends BaseActivity<ImportBillView, ImportBillPresenter> implements View.OnClickListener, ImportBillView {
    //选择银行
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import_creditcard);
    ...
    @Override
    public ImportBillPresenter initPresenter() {
        return new ImportBillPresenter();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
            case R.id.tv_back:
                ImportCreditCardActivity.this.finish();
                break;
            case R.id.ll_visa_type:
                CommonUtils.startResultNewActivity(ImportCreditCardActivity.this, null, SelectBankActivity.class, BANK);
                break;
