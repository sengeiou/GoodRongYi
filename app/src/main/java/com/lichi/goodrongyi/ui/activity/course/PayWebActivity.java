 ...
 * H5支付界面
 */
public class PayWebActivity extends BaseActivity<WebHtmlView, WebPresenter> implements View.OnClickListener {
...
//        webView.setInitialScale(1);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (page % 2 == 0) {
                try {
                    ...
                    finish();
                    AppManager.getAppManager().finishActivity(PurchaseCourseActivity.class);
                    /**
                     * 打开QQ 聊天
                     */
                    ...
                    e.printStackTrace();
                    CommonUtils.showToast(PayWebActivity.this, "请检查是否安装QQ");
                    finish();
                }
            } else {
                view.loadUrl(url);
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView webView, boolean isDialog, boolean isUserGesture, Message resultMsg) {
            WebView newWebView = new WebView(PayWebActivity.this);
