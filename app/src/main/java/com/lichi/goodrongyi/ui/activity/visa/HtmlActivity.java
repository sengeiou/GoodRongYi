 ...
 * H5+分享页面
 */
public class HtmlActivity extends BaseActivity<WebHtmlView, WebPresenter> implements View.OnClickListener {
...
//        webView.setInitialScale(1);
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView webView, boolean isDialog, boolean isUserGesture, Message resultMsg) {
            WebView newWebView = new WebView(HtmlActivity.this);
...
//        return super.onCreateWindow(webView, isDialog, isUserGesture, message);
    ...
    public void init() {
        mShareListener = new HtmlActivity.CustomShareListener(HtmlActivity.this);
        /*增加自定义按钮的分享面板*/
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        if (snsPlatform.mShowWord.equals("umeng_sharebutton_copy")) {
                            Toast.makeText(HtmlActivity.this, "复制文本按钮", Toast.LENGTH_LONG).show();
                        } else if (snsPlatform.mShowWord.equals("umeng_sharebutton_copyurl")) {
                            Toast.makeText(HtmlActivity.this, "复制链接按钮", Toast.LENGTH_LONG).show();

                        } else if (share_media == SHARE_MEDIA.SMS) {
                            new ShareAction(HtmlActivity.this).withText("来自分享面板标题")
                            ...
                            web.setThumb(new UMImage(HtmlActivity.this, url));
...
/*                //设置contentView
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private CustomShareListener(HtmlActivity activity) {
