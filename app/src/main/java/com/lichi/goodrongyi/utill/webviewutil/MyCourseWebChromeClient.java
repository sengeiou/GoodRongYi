 ...
 */
public class MyCourseWebChromeClient extends WebChromeClient {
    ...
    public MyCourseWebChromeClient(IWebPageView mIWebPageView) {
        this.mIWebPageView = mIWebPageView;
        this.mActivity = (CourseContentActivity) mIWebPageView;
    }
