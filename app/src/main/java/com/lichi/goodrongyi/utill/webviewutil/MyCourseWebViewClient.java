package com.lichi.goodrongyi.utill.webviewutil;
...
import com.lichi.goodrongyi.utill.CheckNetwork;
 ...
 * - 添加javascript监听
 */
public class MyCourseWebViewClient extends WebViewClient {

    private IWebPageView mIWebPageView;
    private CourseContentActivity mActivity;

    public MyCourseWebViewClient(IWebPageView mIWebPageView) {
        this.mIWebPageView = mIWebPageView;
        mActivity = (CourseContentActivity) mIWebPageView;
