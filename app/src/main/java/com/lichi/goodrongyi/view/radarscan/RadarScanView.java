package com.lichi.goodrongyi.view.radarscan;
...
public class RadarScanView extends View {
    ...
    public void Start(Context context, boolean isStarts) {
        isStart = isStarts;
        handler.postDelayed(run, 10);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader shader = new SweepGradient(centerX, centerY, Color.parseColor("#00d75959"),
                Color.parseColor("#ffd75959"));
